	...
	public function showdetailinfo($client_id) {
        ...
        if(count($properties) == 1){
     	...
     	$client = DB::table('clients')
     		->where('client_id', '=', $client_id)
     		->get()->first();
		return view('/dashboard/clients/clientdetailinfo', compact('client', 'teams', 'properties','contacts','quotes','jobs','total','invoices','client_id','tag_arr','attachments', 'visits', 'billings', 'tasks', 'event'));
	}
