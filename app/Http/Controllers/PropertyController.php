...
class PropertyController extends Controller {
	...
	public function index() {
		...
		foreach ($properties as $key=>$property) {
			$client = DB::table('clients' )
                	->select('first_name', 'last_name','use_company')
        ...
        $clients= new clients();
        $clients =Clients::where('user_id','=',$auth_id)->get();
		...
		return view('/dashboard/clients/property', compact('properties','clients'));
	}
	...
	public function showdetailinfo(request $request,$property_id){
		...
		return view('/dashboard/clients/propertydetailinfo',compact('teams','client', 'contacts', 'property','viewtax','quotes','data','total','jobs', 'visits', 'tasks', 'session', 'event'));
	}
