...
<link href="{{url('pulbic/css/plugins/dataTables/dataTables.bootstrap.css')}}" rel="stylesheet">
<link href="{{url('public/css/plugins/dataTables/dataTables.responsive.css')}}" rel="stylesheet">
<link href="{{url('public/css/plugins/dataTables/dataTables.tableTools.min.css')}}" rel="stylesheet">
