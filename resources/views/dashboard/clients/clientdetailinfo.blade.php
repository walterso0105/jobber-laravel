            ...
            <div class="ibox-content">
                <div class="row  content-up">
                    ...
                    <div class="">
                        ...
                        <div class="">
                            <?php if($key==0):?>
                               <h2 class="capitalize_label">{{$property->first_name}} &nbsp {{$property->last_name}}</h2>
                            <?php endif;?>
                        </div>
                        @endforeach
                    </div>
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="pull-right">
                                        @foreach($contacts as $key=>$contact)
                                            <div class="">
                                                <?php if($key==0):?>
                                                   <button type="button" class="btn " onclick="location.href='{{url('dashboard/properties/newproperty/'.$contact->client_id)}}'" >+ New Property</button>
                                                <?php endif;?>
                                            </div>
                                        @endforeach
                                    </div>
                                                                ...
                                                                <div class="row v-margin">
                                                                    <div class="columns col-xs-5">
                                                                        ...
                                                                        visit for job # {{$visit->job_id}} - <span class="normal">{{$visit->description}}<br>
                                                                         ...
                                                                         <small class="paragraph">re:{{$visit->first_name}} {{$visit->last_name}}</small>
        ...
        <form method="post" action="/dashboard/clients/detail/payment/sendemail">
            ...
            <div class="">
             <div class=" panel-default">
                <div class="panel-heading">
                     <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                    <div class="title">E-mail Receipt to {{$client->first_name}} {{$client->last_name}}</div>
                </div>
                 <div class="panel-body billing-body ">
                    <div class="feed-element element-margin">
                        <div class = "row m-padding">
                    ...
                    <div class="col-lg-4 detail-job">
                        ...
                        <br>
                            <label class="col-sm-12">
                                Client
                                <a href="/dashboard/clients/detail/{{$client->client_id}}" class="task-client-link">{{$client->first_name}} &nbsp{{$client->last_name}}</a>
                            </label>
                        <br>
                            <label class="col-sm-12">
                                    Phone
