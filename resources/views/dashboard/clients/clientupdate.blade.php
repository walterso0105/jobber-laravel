                            ...
                            <div class="body-auth">
                                ...
                                <div class="row show-grid auth">
                                 ...
                                 <?php if($clients->first()->use_company ==1):?>
                                    ...
                                    <label class="companycheck">
                                        <div class="check_left">
                                        <input class="i-checks " type="checkbox"  value="1" name="companycheck" checked="checked">
                                        <span><h4>Use company name as the primary   name</h4></span> </div>
                                        </label>
                                    </div>  
                                <?php else:?>
                                    <div class="checkbox style-ichecks">
                                    <label class="companycheck">
                                        <div class="check_left">
                                        <input class="i-checks " type="checkbox"  value="1" name="companycheck">
                                        <span><h4>Use company name as the primary   name</h4></span> </div>
                                        </label>
                                    </div>  
                                <?php endif;?>
                    ...
                    <div class="ibox ibox-content ">
                        ...
                        <div class="ibox-content-body">
                            ...
                            <?php if($countproperty>1):?>
                                 ...
                                 @foreach($properties as $property)
                                     <?php if($property->type ==2):?>
                                            <div class="checkbox i-checks auth">
                                                <label class="flex-div flex-div-second">
                                                    <input id="billing-address" value="1" class="i-checks" type="checkbox" name="billing-check" checked>  <span><h4>Billing address is the same as     property address</h4><span>
                                                </label>
                                            </div>
                                       ...
                                       <?php elseif($property->type == -1):?>
                                            <div class="checkbox i-checks auth">
                                                <label class="flex-div flex-div-single">
                                                    <input id="billing-address-single" value="1" class="i-checks " type="checkbox" name="billing-check">  <span><h4>Billing address is the same as     property address</h4><span>
                                                </label>
                                            </div>
                                ...
                                <div class="checkbox i-checks auth">
                                    <label class="flex-div flex-div-second">
                                        <input id="billing-address" value="1" class="i-checks " type="checkbox" name="billing-check" checked ="checked"/>  <span><h4>Billing address is the same as     property address</h4><span>
                                    </label>
                                </div>
                           ...
                           @endforeach
                            <?php elseif($countproperty == 0):?>
                                ...
                                <div class="checkbox i-checks auth">
                                    <label class="flex-div flex-div-second">
                                        <input id="billing-address" value="1" class="i-checks " type="checkbox" name="billing-check" />  <span><h4>Billing address is the same as     property address</h4><span>
                                    </label>
                                </div>
