                                ...
                                <div class="panel-body">
                                    <div class="feed-element">
                                        <div class="property-auth-info">
                                            ...
                                            <span class=""><a href='{{url('dashboard/clients/detail/'.$property[0]->client_id)}}'>{{$property[0]->first_name}}&nbsp {{$property[0]->last_name}}</a></span>
                                        </div>
                                                            ...
                                                            <div class="columns col-xs-11 visitView" data-id="{{$visit->visit_id}}">
                                                                <div class="row v-margin">
                                                                    <div class="columns col-xs-5">
                                                                        ...
                                                                        re:{{$visit->first_name}} {{$visit->last_name}}</span>
