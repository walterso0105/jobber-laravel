                                            ...
                                            <div class="ibox">
                                                <div class="ibox-title">
                                                    ...
                                                    <div class="hide" id="assignMenu">
                                                        ...
                                                        <a href="#" class="u-block text-center" data-toggle="modal" data-target="#newUser">Add user</a>
                                                    </div> -->
                                                ...
                                                <div class="ibox-content">
                                                    ...
                                                    <select data-placeholder="Choose Team..." class="chosen-select select-team" multiple style="width:100%;" tabindex="4" onchange="selectTeam(this)" id="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"  id="teamMember2">
                                            <div class="ibox">
                                                ...
                                                <div class="ibox-content">
                                                    <select data-placeholder="Choose Team..." class="chosen-select chosen-select1" multiple style="width:100%;" tabindex="4" onchange="selectTeam(this)" id="team_list1">
                                                        @foreach($data['teams'] as $team)
                                                            <option value="{{$team->team_member_id}}">{{$team->fullname}}</option>
                                                        @endforeach
                                                    </select>
                                                    <label class="check-element">
                                                        <input type="checkbox" class="check-button" name="notify" value="2">
                                                        <i class="checkbox fa"></i>
                                                        <span class="paragraph">
                                                           Notify team by email
                                                        </span>
                                                ...
                                                <!-- <div class="ibox-content">
                                                    ...
                                                    <label class="check-element">
                                                        <input type="checkbox" class="check-button" value="1" name="notify2"/>
                                                        <i class="checkbox fa"></i>
                                                        <span class="paragraph">
                                                           Notify team by email
                                                        </span>
