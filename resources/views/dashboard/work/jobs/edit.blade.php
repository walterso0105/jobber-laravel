...
<link rel="stylesheet" type="text/css" href="{{url('public/css/progress-bar.css')}}">
                            ...
                            @if($data['job'][0]->job_type == '1')
                                <div id="tab-1" class="tab-pane active">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"  id="teamMember1">
                                            <div class="ibox">
                                                <div class="ibox-title">
                                                ...
                                                <div class="ibox-content">
                                                    <!-- <div class="chosen-container chosen-container-multi chosen-with-drop">
                                                        <ul class="chosen-choices" id="team_members1">
                                                            <li class="search-choice"><span>member1</span><a class="search-choice-close" data-option-array-index="105"></a></li>
                                                            <li class="search-choice"><span>member2</span><a class="search-choice-close" data-option-array-index="176"></a></li>
                                                            <li class="search-choice"><span>member3</span><a class="search-choice-close" data-option-array-index="2" onclick=""></a></li>
                                                        </ul>
                                                    </div> -->
                                                    ...
                                                    <select data-placeholder="Choose Team..." class="chosen-select" multiple style="width:100%;" tabindex="4" onchange="selectTeam(this)">
                                                        @foreach($data['teams'] as $team)
                                                            @if(in_array($team->team_member_id, explode(',', $data['job'][0]->member_id)))
                                                    ...
                                                    <label class="check-element u-marginTop">
                            ...
                            @else
                                <div id="tab-2" class="tab-pane active">
                                    <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="input-group date" id="dateStart">
                                                                        <input type="text" class="action-border input-lg form-control input-group-addon text-center" name="startDate1" value="{{$data['job'][0]->date_started}}" onchange="calculateDates();"/>
                                        ...
                                        <div class="col-md-4"  id="teamMember2">
                                            <div class="ibox">
                                                <div class="ibox-title">
                                                    <h3 class="headingTwo">Team</h3>
                                                    <!-- <button type="button" class="assign-btn assign-btn-sm right-btn" data-container="body" data-toggle="popover" data-placement="left" data-content="" id="assignButton" data-trigger="">
                                                        + Assign
                                                    </button> -->
                                                    <!-- <div class="hide" id="assignMenu">
                                                        <ul class="assign-menu">
                                                            <li class="u-borderBottom">
                                                                <label class="check-element">
                                                                    <input type="checkbox" class="check-button" name="" value="member1">
                                                                    <i class="checkbox fa"></i>
                                                                    <span>
                                                                        Member1
                                                                    </span>
